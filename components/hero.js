  ...
  return (
    <div className={`w-screen h-screen my-20 max-md:my-10 ${poppins.className}`}>
      <div className="flex items-center space-x-10 justify-center h-full text-white max-md:flex-col max-md:px-8 max-md:space-x-0 max-md:items-center max-md:py-30">
        <Image src="/cats.png" alt="Hero Image" width={200} height={400} className="rounded-lg mb-8 max-md:w-[150px]" style={{ maxWidth: '100%', height: 'auto' }} />
        <div className="flex flex-col items-start space-y-0 max-md:items-center max-md:text-center">
          <h1 className="text-7xl text-black font-bold max-md:text-5xl">MAMCING</h1>
          <h1 className="text-4xl text-black font-semibold mt-[-10px] max-md:text-2xl max-md:mt-0">Kasih mam si kucing</h1>
          <div className="flex justify-center my-4 py-5 max-md:py-1">
